...
export function InstallPrompt({
  ...
  return (
    <div className={`fixed inset-x-0 z-50 mx-auto max-w-lg px-4 ${offsetClass}`}>
      <div className="flex items-center justify-between gap-3 rounded-xl border border-accent/30 bg-[#0d3428]/95 px-3 py-3 backdrop-blur">
